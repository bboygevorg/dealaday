...
import { InputGray } from "../../components/Input/input";
...
const Header = () => {
  ...
  return (
    <>
      <div className={toggleMenu ? classes.active : classes.activeOff}>
        <MenuMobile toggleActive={toggleActive} closeSlideBar={closeSlideBar} />
      </div>
