...
const Filter = ({
  ...
  const { selectedCategory, selectedBrand, selectedRating } = useSelector(
  ...
  const handleColorsChange = (index) => {
    onColorsChange(index + 1);
  };
    ...
    <>
      ...
      >
        <div className={classes.mobile}>
          <div className={classes.back_menu} onClick={handleOfFilter}>
            <svg
              width="14"
              height="14"
              viewBox="0 0 24 24"
        ...
        <div className={classes.button_filter}>
          <div>
            <Button size="long" color="gray">
              Clear
            </Button>
          </div>
          <div>
            <Button size="long" color="blue" handleOfFilter={handleOfFilter}>
              Apply
            </Button>
          </div>
        </div>
